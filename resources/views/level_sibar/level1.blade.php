                                ...
                                <form id="form_edit_book" name="form_edit_book" method="post" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><label for="">Mã nội dung</label><input
                                            class="form-control" type="hidden" name="id_content" id="id_content"></div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="form_edit_content" name="form_edit_content" method="post" class="form-horizontal">
                                    @csrf
                                    <div class="row form-group">
                                        <div class="col-12 col-md-9"><textarea type="text" class="form-control"
                                    ...
                                    <div class="col-12 col-md-4">
                                            ...
                                            @if ($data_level1->currentPage() - 2 < 0)
                                                @for ($i = $data_level1->currentPage(); $i <= $data_level1->lastPage(); $i++)
                                                    @if ($i == $data_level1->currentPage())
                                                        <a href="http://127.0.0.1:8000/level.html/{{$data['id_level']}}?page={{ $i }}"><span
                                                ...
                                                @endfor
                                            @else
                                                <a href="http://127.0.0.1:8000/level.html/{{$data['id_level']}}?page=1"><span
                                        ...
                                        @else
                                            @if ($data_level1->currentPage() == 1)
                                                ...
                                                @endfor
                                                <a
                                                    href="http://127.0.0.1:8000/level.html/{{$data['id_level']}}?page={{ $data_level1->lastPage() }}"><span
...
<script>
    $(document).ready(function(){
        ...
        $('#form_edit_book').on('submit', function(event) {
            ...
            var url_edit = "{{ route('updatelevelchapterlessonandcontent') }}";
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    console.log(data[0]['id_content'])
                     var row = $(".table-stats button[id='" + data[0]['id_content'] + "']")
                         .parents("tr")[0];
                     console.log(row)
