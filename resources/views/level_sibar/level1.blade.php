                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="form_edit_content" name="form_edit_content" method="post" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-12 col-md-9"><input
                                            class="form-control" type="hidden" name="id_content_detail" id="id_content_detail"></div>
                                        <div class="col-12 col-md-9"><label for="">Mã nội dung</label><textarea type="text" class="form-control"
