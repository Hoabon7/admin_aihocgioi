                                    ...
                                    <div class="col-12 col-md-4">
                                            ...
                                            @if ($data_level1->currentPage() - 2 < 0)
                                                @for ($i = $data_level1->currentPage(); $i <= $data_level1->lastPage(); $i++)
                                                    @if ($i == $data_level1->currentPage())
                                                        <a href="{{$url_root}}/level.html/{{$data['id_level']}}?page={{ $i }}"><span
                                                ...
                                                @endfor
                                            @else
                                                <a href="{{$url_root}}/level.html/{{$data['id_level']}}?page=1"><span
                                        ...
                                        @else
                                            @if ($data_level1->currentPage() == 1)
                                                ...
                                                @endfor
                                                <a
                                                    href="{{$url_root}}/level.html/{{$data['id_level']}}?page={{ $data_level1->lastPage() }}"><span
